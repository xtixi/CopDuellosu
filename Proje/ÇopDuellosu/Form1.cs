...
namespace ÇopDuellosu
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            BackgroundImage = Image.FromFile("AnaMenuR.png");
        ...
        {
            Process.Start("https://github.com/xtixi/CopDuellosu");
        }

        private void button8_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Bob doğma büyüme Texsas’ın Sindy kasabasında yaşamış bir şerifti hayatı boyunca bir çok suçlu yakalayıp hayatını onlarca kez riske atmıştı ve artık emekliliğinin zamanı gelmişti ailesi ile birlikte huzurlu ve güvenli bir hayata hazırdı işteki son gününü geçirdi yeni şerife armasını teslim etti ve çalışanlar tarafından uğurlandı çok mutluydu ta ki evine dönene kadar eve döndüğünde karısı baygın bir şekilde yerde yatıyordu etraf kırılıp dökülmüştü ve oğlu hiçbir yerde gözükmüyordu karısı uyanınca oğlunu bir kaç tane adamın gelip götürdüğünü ve boba onu tekrar görmek istiyorsa peşlerinden gelmesi gerektiğini söyleyen bir kâğıt parçası verdi bunun üzerine bob silahını aldı ve yola koyuldu belki artık rozeti olmayabilirdi ama işi hala bitmemişti.");
        }
    }
}
